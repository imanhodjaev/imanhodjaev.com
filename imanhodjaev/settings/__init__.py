...
overrides = __import__(ENV, globals(), locals(), ['settings'])
...
for attr in dir(overrides):
    ...
    if attr.isupper():
        # update our scope with the imported variables. We use
        # globals() instead of locals()
        # because locals() is readonly and it returns a copy of
        # itself upon assignment.
